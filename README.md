...
- **digi-brand-guidelines** — the brand spine. Palette, typography, logo rules,
  ...
  official template's theme XML rather than transcribed, so it cannot drift.
  Every other skill reads this one.
- **digi-pptx** — Digi presentations built on the official template. The slide
  master supplies the green bar, logo, footer, fonts, and correct geometry.
